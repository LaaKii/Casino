...
<body class="basicBody">
	...
	<div class="content">
		...
		<a onmouseover="showTitle('Profil')" onmouseout="hideTitle()" href="${pageContext.request.contextPath}/others/profile.jsp"><img height="250" width="250" src="${pageContext.request.contextPath}/Ressources/profile.png"></a>
	</div>
<footer>
